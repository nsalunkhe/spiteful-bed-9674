  ...
  return (
    <div className={classes.root}>
      <Grid container direction="row" justify="center" alignItems="center">
        <Grid item xs={12}>
          <AppBar position="static" style={{ background: "#2E3B55",marginTop:"5px" }}>
            <Toolbar>
              <Typography
                variant="h6"
                style={{
        ...
        <Grid item xs={6}>
          <Card variant="outlined" style={{ marginTop: "3%",border:"1px solid #C70039"}}>
            <CardContent>
              <Grid
                container
                direction="row"
              ...
              >
                <Grid item xs={12}>
                  <AppBar
                    position="static"
                    style={{ background: "#C70039", alignItems: "center" }}
                  >
                    <Toolbar>
